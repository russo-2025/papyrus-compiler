...
Этот компилятор намеренно отличается от оригинального компилятора Papyrus от Bethesda в обработке переносов строк.
...
### 2. Переносы строк внутри инструкции

Оригинальный компилятор Bethesda требует завершающий обратный слеш `\`, чтобы продолжить инструкцию на следующей строке. Этот компилятор принимает инструкцию, разбитую на несколько строк, **как с завершающим `\`, так и без него**:
